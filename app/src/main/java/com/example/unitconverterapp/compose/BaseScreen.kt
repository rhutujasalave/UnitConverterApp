...
//lazy column is quivalent to recycler view in jetpack compose
@Composable
fun BaseScreen(
   ...
   val configuration = LocalConfiguration.current          // for listen orientation changes(like landscape orientation n all)
